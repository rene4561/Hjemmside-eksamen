    ...
    <body>
        ...
        <div id=pagewrap>
            <section id="indhold">
                <div id="oversigt">
                    <h1>Gestaltlovene</h1>
                    <p>Gestaltlovene beskriver, hvordan vores hjerner opfatter helheder i omverdenen og hvorledes vi sanser dem.</p>
                ...
                <section id="underemne5">
                    <h2>Loven om figur og baggrund</h2>
