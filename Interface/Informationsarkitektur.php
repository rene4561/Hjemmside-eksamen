        ...
        <div id=pagewrap>
            <section id="indhold">
                <div id="oversigt">
                    ...
                    <p>En hjemmeside er i sin essens, en masse siders information fordelt på tværs af dokumenter. Disse sider kan være forbundne på utallige måder gennem hyperlinks, hvilket kan betyde at en hjemmesides kompleksitet kan være enormt. For denne kompleksitet ikke bliver et problem for brugeren, er informationsarkitektur blevet konceptualiseret.</p> 
                    <p>Formålet med informationsarkitektur er, at skabe et hierarki og struktur til navigering af hjemmesiden. Ligeledes at det føles naturligt for brugeren og at de selv føler kontrol over hvor de bliver naveret hen.</p>
                    <p>Alle brugere danner sig en forestilling om hvor tingene er placeret på hjemmesiden – god informationsarkitektur der derfor, at brugerens forestilling bliver til virkelighed. 
                    - kommunikation i multimediedesign, s.165-166.</p>
                    ...
                    It's like a film with no director. The actors may be good, the sets may be lovely, but audiences will leave soon after the opening credits.
                    - Jeffrey Zeldman (stifter af A List Apart) </blockquote>
                </div>
